...
var ConstructorsByReflectType = map[reflect.Type]func(ctx context.Context, limit int) ast.Node{
...
func ConstructWithReflectType(typeOf reflect.Type, ctx context.Context, limit int) {
	ConstructorsByReflectType[typeOf](ctx, limit)
}
